...
STATIC const mp_rom_map_elem_t board_module_globals_table[] = {
    ...
    // Stove MOS Drivers
    { MP_ROM_QSTR(MP_QSTR_STOVE_DRIVER1_1), MP_ROM_PTR(&pin_GPIO_EMC_23)},
    { MP_ROM_QSTR(MP_QSTR_STOVE_DRIVER1_5), MP_ROM_PTR(&pin_GPIO_EMC_24)},
    { MP_ROM_QSTR(MP_QSTR_STOVE_DRIVER1_2), MP_ROM_PTR(&pin_GPIO_SD_B0_02)},
    { MP_ROM_QSTR(MP_QSTR_STOVE_DRIVER1_6), MP_ROM_PTR(&pin_GPIO_SD_B0_03)},
    { MP_ROM_QSTR(MP_QSTR_STOVE_DRIVER1_3), MP_ROM_PTR(&pin_GPIO_EMC_27)},
    { MP_ROM_QSTR(MP_QSTR_STOVE_DRIVER1_7), MP_ROM_PTR(&pin_GPIO_SD_B0_05)},
    { MP_ROM_QSTR(MP_QSTR_STOVE_DRIVER1_4), MP_ROM_PTR(&pin_GPIO_SD_B1_00)},
    { MP_ROM_QSTR(MP_QSTR_STOVE_DRIVER1_8), MP_ROM_PTR(&pin_GPIO_SD_B1_01)},
    { MP_ROM_QSTR(MP_QSTR_STOVE_DRIVER2_1), MP_ROM_PTR(&pin_GPIO_EMC_06)},
    { MP_ROM_QSTR(MP_QSTR_STOVE_DRIVER2_5), MP_ROM_PTR(&pin_GPIO_EMC_07)},
    { MP_ROM_QSTR(MP_QSTR_STOVE_DRIVER2_2), MP_ROM_PTR(&pin_GPIO_EMC_08)},
    { MP_ROM_QSTR(MP_QSTR_STOVE_DRIVER2_6), MP_ROM_PTR(&pin_GPIO_EMC_09)},
    { MP_ROM_QSTR(MP_QSTR_STOVE_DRIVER2_4), MP_ROM_PTR(&pin_GPIO_SD_B1_02)},
    { MP_ROM_QSTR(MP_QSTR_STOVE_DRIVER2_7), MP_ROM_PTR(&pin_GPIO_SD_B1_03)},
    { MP_ROM_QSTR(MP_QSTR_STOVE_DRIVER2_8), MP_ROM_PTR(&pin_GPIO_EMC_31)},
    { MP_ROM_QSTR(MP_QSTR_STOVE_DRIVER2_3), MP_ROM_PTR(&pin_GPIO_EMC_32)},
    ...
    // some spi ADC CS
    { MP_ROM_QSTR(MP_QSTR_SPI_ADC_CS), MP_ROM_PTR(&pin_GPIO_SD_B0_01)},

    // V-sense and I-sense
    { MP_ROM_QSTR(MP_QSTR_VSENSE_VBUS), MP_ROM_PTR(&pin_GPIO_AD_B0_15)},
    { MP_ROM_QSTR(MP_QSTR_ISENSE_BRIDGE_LB), MP_ROM_PTR(&pin_GPIO_AD_B1_11)},
    { MP_ROM_QSTR(MP_QSTR_ISENSE_BRIDGE_LT), MP_ROM_PTR(&pin_GPIO_AD_B0_12)},
    { MP_ROM_QSTR(MP_QSTR_ISENSE_BRIDGE_RB), MP_ROM_PTR(&pin_GPIO_AD_B1_00)},
    { MP_ROM_QSTR(MP_QSTR_ISENSE_BRIDGE_RT), MP_ROM_PTR(&pin_GPIO_AD_B1_01)},
    { MP_ROM_QSTR(MP_QSTR_ISENSE_COIL_LB), MP_ROM_PTR(&pin_GPIO_AD_B0_13)},
    { MP_ROM_QSTR(MP_QSTR_ISENSE_COIL_LT), MP_ROM_PTR(&pin_GPIO_AD_B0_14)},
    { MP_ROM_QSTR(MP_QSTR_ISENSE_COIL_RB), MP_ROM_PTR(&pin_GPIO_AD_B1_02)},
    { MP_ROM_QSTR(MP_QSTR_ISENSE_COIL_RT), MP_ROM_PTR(&pin_GPIO_AD_B1_03)},
